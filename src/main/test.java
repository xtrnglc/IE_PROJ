    ...
    */
    ...
    if (args.length > 1) {
      ...
      */
      ...
      String[] example = {"Moreover, seroconversion makes the eradication of Herpes B within such a population next to impossible (Ward & Hilliard 1994, Klots et al 1998).",
                           };
