...
public class Driver {
	...
	public static HashMap<String, String> calculateRecall(Article output, Article answer) {
		...
		result.put("containment",
				dec.format(containmentRecall).toString() + "(" + containmentLabeledCount + "/" + containmentTrueCount);
	...
	public static HashMap<String, String> calculatePrecision(Article output, Article answer) {
		...
		result.put("victim",
				dec.format(victimPrecision).toString() + "(" + victimCorrectlyLabeledCount + "/" + victimLabeledCount);
